  ...
  return (
    <div>
      ...
      <form onSubmit={addCourse}>
        <label>
          Course title:
          <input type="text" name="courseTitle"></input>
        </label>
        <label>
          Course price:
          <input type="number" name='coursePrice' step="0.01"></input>
        </label>
        <label>
          Course start date
        ...
        <label>
          Max course places:
          <input type='number' name='courseMaxPlaces' ></input>
        </label>
        <label>
          Available course places:
          <input type='number' name='courseAvailablePlaces'></input>
        </label>
